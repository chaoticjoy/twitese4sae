...
<div id="statuses">
	...
	<div id="info_head">
		...
		<?php if ($isFollower) {?>
			<a id="list_block_btn" class="info_btn_hover" href="a_list.php?action=destory&id=">取消关注</a>
		<?php } else { ?>
			<a id="list_follow_btn" class="info_btn" href="a_list.php?action=create&id=">关注推群</a>
		<?php } ?>
